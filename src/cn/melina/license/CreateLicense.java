...
//	发布时间
	...
	public void setParam(String propertiesPath) {
		...
		macAddress = prop.getProperty("deviceInfo");
		maxAgent = prop.getProperty("maxAgent");
	}
	...
	// 从外部表单拿到证书的内容
		public final static LicenseContent createLicenseContent() {
			...
			System.out.print(macAddress+"###"+maxAgent);
			extraInfo.put("deviceInfo", macAddress);
			extraInfo.put("maxAgent", maxAgent);
